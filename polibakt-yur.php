			...
			<div class="row ">
				...
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left">
					...
					<div class="frame-size">
						...
						<ul>
							<li class="active my-active">до 10л</li>
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
                            <!-- <h5 class="title"><span><a target="_blank" href="http://inmi/wp-content/uploads/2026/06/gordebak-reg.pdf">Свидетельство о гос. рег. - открыть</a></span></h5> -->
